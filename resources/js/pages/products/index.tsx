...
export default ({ categoryOptions: coptions, pagination, locationOptions, unitOptions }: Props) => {

    const flash = usePage<SharedData>().flash as { success?: string, error?: string }
