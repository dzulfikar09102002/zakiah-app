import {
    ...
    LocationChooserList,
} from '@/components/reports/stocks/remainings/location-chooser';
        ...
        >
            ...
            <div className="mb-4 grid gap-2 lg:flex">
                <Dialog>
                    ...
                    <DialogContent>
                        <LocationChooserContainer
                            locations={locations}
                            search={dSearch}
                            onSearch={locationDialogOnSearch}
                        >
                            <DialogHeader>
                ...
                <Button
                    ...
                    onClick={() => {
                        window.open(
                            `/stock-remaining/${location.id}/export`,
                            '_blank',
                        );
                    }}
                >
            ...
            <Card>
                    ...
                    <Form method="GET" className="grid gap-2 lg:flex">
                        <Combobox
                            ...
                            defaultValue={categoryOptions.find(
                                (el) => el.value == product_category_id,
                            )}
                        >
                            <ComboboxInput
                ...
                <CardContent>
                    <Table className="stripped">
                        ...
                        <TableBody>
                            {pagination.data.map(
                                (report: ProductStock, index: number) => (
