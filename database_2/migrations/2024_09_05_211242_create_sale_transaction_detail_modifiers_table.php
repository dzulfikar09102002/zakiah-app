...
return new class extends Migration
{
    ...
    {
        Schema::create('sale_transaction_detail_modifiers', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer("quantity")->unsigned(); # same with sale detail
            $table->integer("cancelled_quantity")->unsigned(); # same with sale detail
    ...
    {
        Schema::dropIfExists('sale_transaction_detail_modifiers');
    }
};
