...
return new class extends Migration
{
    ...
    {
        Schema::create('loyalty_reward_product_locations', function (Blueprint $table) {
            $table->id();
            $table->foreignIdFor(Entity::class);
            $table->foreignIdFor(Loyalty::class);
            $table->foreignIdFor(LoyaltyRewardProduct::class);
            $table->foreignIdFor(LoyaltyRewardProductModifier::class)->nullable();
    ...
    {
        Schema::dropIfExists('loyalty_reward_product_locations');
    }
};
