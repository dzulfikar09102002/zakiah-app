...
return new class extends Migration
{
    ...
    {
        Schema::create('product_opname_service_details', function (Blueprint $table) {
            $table->id();
            $table->foreignIdFor(ProductOpnameService::class);
    ...
    {
        Schema::dropIfExists('product_opname_service_details');
    }
};
